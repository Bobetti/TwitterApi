...
//source: https://www.thatsoftwaredude.com/content/6289/how-to-post-a-tweet-using-c-for-single-user

namespace TwitterApi
{
    public class TwitterAPI_1
    {
        ...
        public TwitterAPI_1(string oAuthConsumerKey, string oAuthConsumerSecret, string accessToken, string accessTokenSecret, string endPoint)
        {
        ...
        public void SendTweet(string message)
        {
            ...
            string postBody = "text:" + Uri.EscapeDataString(message);

            HttpWebRequest authRequest = (HttpWebRequest)WebRequest.Create(_endPoint);
        ...
        private string GenerateOauthSignature(string status, string nonce, string timestamp)
        {
            ...
            result += "POST&";
            result += Uri.EscapeDataString(_endPoint);
            result += "&";
